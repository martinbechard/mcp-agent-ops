...
complete self-contained page. Compact icon controls follow the level presets: overlapping pages
copies the content, plus expands all levels, and minus collapses all levels. **Copy content** copies
only the complete hierarchy as indented plain text. Compare each preview with its Presentation
parameters callout to see which appearance and interaction options produced it.
